                ...
                if (s.equalsIgnoreCase("create") && sender instanceof Player) {
                    ...
                    if (block.getState() instanceof Chest) {
                        ...
                        if (!PartyRoom.getPlugin().handler.isPartyChest(chest)) {
                            ...
                            new PartyChest(Utilities.LocToString(chest.getLocation()), "" + id, false, 20, Material.CAKE, (byte) 0, new PullCost(), RegionTarget.RADIUS, YSpawnTarget.DEFAULT, 0, 0, 0, 0, "&6Drop Party will start in &e%TIME%&6!", "§6Drop Party has started!", 10, "", false, null, null);
